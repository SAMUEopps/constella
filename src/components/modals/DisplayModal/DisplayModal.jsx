...
const previewText = "At the heart of X are short messages called posts — just like this one — which can include photos, videos, links, text, hashtags, and mentions like #@Constella#"
            ...
            <div className="display-modal_preview">
                ...
                <div className="preview-container">
                    <div className="preview-author">
                        <p className="display_name">Constella</p>
                        <p className="username">#@Constella# · 33m</p>
                    </div>
