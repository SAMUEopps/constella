...
const Bookmarks = () => {
    ...
    return (
        <main>
            <Helmet>
                <title>Bookmarks / Constella</title>
            </Helmet>
            ...
            <MiddleColumn>
                ...
                <PaginatedList
                    ...
                    renderPlaceholder={() => (
                        <Placeholder
                            title="Save Starcasts for later"
                            subtitle="Don't let the good ones fly away! Bookmark Starcasts to easily find them again in the future."
                        />
                    )}
                />
            </MiddleColumn>
